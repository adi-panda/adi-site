...
<main
  class="h-screen w-full flex items-center justify-center overflow-x-hidden px-4"
>
  <div class="flex flex-col lg:flex-row items-center justify-center mx-auto">
    <Button
      onclick={toggleMode}
      variant="outline"
      size="icon"
    ...
    >
      ...
      <div class="flex flex-col gap-2 pb-4">
        ...
        <span class="text-xl text-foreground">
          👋 hey! i'm adi, an engineer @ <a
            href="https://krea.ai"
            class="underline">krea</a
          > and studying cs at ut austin. i ❤️ visual computing, ml and consumer
          products.
        </span>
        <span class="text-xl text-foreground">
      ...
      <ul class="text-md text-foreground list-disc ml-4 cursor-default">
        ...
        <li class="transition-all duration-200 ease-in-out hover:translate-x-2">
          worked on custom creative tools for leading studios at
          <a href="https://hyperbrew.co" class="underline">hyperbrew</a>.
        </li>
        <li class="transition-all duration-200 ease-in-out hover:translate-x-2">
          made a
          <a href="https://youtube.com/@awdii" class="underline"
            >youtube channel</a
          >
    ...
    <div
      class="slide-in-from-left transform -translate-x-28 -translate-y-8 md:-translate-x-0 pt-[3rem] w-[40rem] flex items-center justify-center"
    >
      <AsciiVideoPlayer />
    </div>
  </div>
